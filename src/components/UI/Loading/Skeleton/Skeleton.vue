...
<template>
  ...
  <div v-if="type === 'paragraph'" :style="inlineStyle" :class="['skeleton-paragraph', rootClassName]">
    <div
      v-for="(_, idx) in paragraphLines"
      :key="idx"
      :style="paragraphOptions.linesStyle"
      :class="['skeleton', 'skeleton-paragraph-line', shapeClassName, paragraphOptions.linesClassName]"
    ></div>
  </div>
</template>
